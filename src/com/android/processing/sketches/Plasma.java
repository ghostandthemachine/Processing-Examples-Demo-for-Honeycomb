...
public class Plasma extends PApplet {
	 ...
	 * 
	 * Cycles of changing colours warped to give an illusion of liquid, organic
	 * movement.Colors are the sum of sine functions and various formulas. Based
	 * on formula by Robert Klep.
	 */
