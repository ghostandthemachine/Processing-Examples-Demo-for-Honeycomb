...
public class UnlimitedSprites extends PApplet {
	 ...
	 * 
	 * An infinate number of sprites drawn to screen. It's basically a
	 * flick-book effect; you draw the same sprite in different positions on
	 * different bufffer 'screens' and flip between them. When you've drawn on
	 * all frames, you loop back to the beginning and repeat.
	 */
	...
	public void draw() {
		...
		spriteFrames[surf].image(sprite, x + (width / 2) - 32, y + (height / 2)
				- 32);
